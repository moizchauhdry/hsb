...
Route::prefix('axios')->group(function () {
    ...
    Route::any('/fetch/departments', [AxiosController::class, 'fetchDepartments'])->name('axios.fetch.departments');
    Route::any('/fetch/groups', [AxiosController::class, 'fetchGroups'])->name('axios.fetch.groups');
