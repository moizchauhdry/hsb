...
import CreateEdit from "./Partial/CreateEdit.vue";
import Import from "./Import/Import.vue";
import PolicyFilter from "./Partial/PolicyFilter.vue";
            ...
            <div class="page-content">
                <div class="page-breadcrumb d-sm-flex align-items-center mb-3">
                    ...
                    <div class="ms-auto" style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <PolicyFilter :filter_route="props.filter_route" :filters="props.filters"></PolicyFilter>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <Search :filters="props.filters" :route_name="route('policy.index')" />
                    </div>
                    <div class="card-body">
