            ...
            <div class="page-content">
                <div class="card">
                                    ...
                                    <tr v-for="(audit, index) in audits" :key="audit.id">
                                                ...
                                                <table class="table table-bordered">
                                                    <tbody>
                                                        <tr v-for="(value, key) in parsedOldValues(audit)" :key="key">
                                                            <th class="bg-light text-dark" style="width: 200px; text-align: left; padding: 8px;">
                                                                {{ formatKey(key) }}
                                                            </th>
                                        ...
                                        <td class="px-2">
                                            <div v-if="Object.keys(parsedNewValues(audit)).length">
                                                <table class="table table-bordered">
                                                    <tbody>
                                                        <tr v-for="(value, key) in parsedNewValues(audit)" :key="key" v-if="key !== 'user_agent'">
                                                            <th class="bg-light text-dark" style="width: 200px; text-align: left; padding: 8px;">
                                                                {{ formatKey(key) }}
                                                            </th>
                                                            <td style="padding: 8px;">
                    ...
                    <div class="card-footer d-flex justify-content-between align-items-center">
                        <span>
                            <h6>Showing {{ props.audits.from }} to {{ props.audits.to }} of {{ props.audits.total }} entries</h6>
                        </span>
